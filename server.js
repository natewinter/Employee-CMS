...
function start(){
    inquirer.prompt({
        ...
        choices:[ "add a department","add a role","add an employee","view departments","view roles","view employees","quit"]
...
function addRole(){
    inquirer.prompt({
        ...
        message:"what is the role you would like to add?"
            ...
            connection.query("INSERT INTO roleTb SET ?",{title:answers.role},function(err){
                if (err) throw err
                start()
            })
        })
